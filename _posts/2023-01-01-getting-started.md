...
- [**Using the dev Starter**](#option-1-using-the-dev-theme-starter) - Easy to upgrade, isolates irrelevant project files so you can focus on writing.
...
#### Option 1. Using the dev Starter

Create a new repository from the [**dev Starter**][use-starter] and name it `<GH_USERNAME>.github.io`, where `GH_USERNAME` represents your GitHub username.

#### Option 2. Forking on GitHub

[Fork **dev**](https://github.com/smlee/dev/fork) on GitHub and rename it to `<GH_USERNAME>.github.io`. Please note that the default branch code is in development.  If you want the site to be stable, please switch to the [latest tag][latest-tag] and start writing.
...
Starting from [`v4.1.0`][dev-4.1.0], if you want to overwrite the SASS variables defined in `_sass/addon/variables.scss`{: .filepath}, create a new file `_sass/variables-hook.scss`{: .filepath} and assign new values to the target variable in it.
...
Also, if you'd like to self-host the static assets, please refer to the [_dev-jekyll-assets_](https://github.com/smlee/dev-jekyll-assets#readme).
...
- If you are using the theme gem (there will be `gem "dev-jekyll-theme"` in the `Gemfile`{: .filepath}), editing the `Gemfile`{: .filepath} and update the version number of the theme gem, for example:

  ```diff
  - gem "dev-jekyll-theme", "~> 3.2", ">= 3.2.1"
  + gem "dev-jekyll-theme", "~> 3.3", ">= 3.3.0"
  ```
  ...
  ```console
  $ bundle update dev-jekyll-theme
  ```

  As the version upgrades, the critical files (for details, see the [Startup Template][starter]) and configuration options will change. Please refer to the [Upgrade Guide](https://github.com/smlee/dev/wiki/Upgrade-Guide) to keep your repo's files in sync with the latest version of the theme.
...
[starter]: https://github.com/smlee/dev-theme-starter
[use-starter]: https://github.com/smlee/dev-theme-starter/generate
[workflow]: https://github.com/smlee/dev/blob/master/.github/workflows/pages-deploy.yml.hook
[dev-1.0.0]: https://github.com/smlee/dev/releases/tag/v1.0.0
[pages-workflow-src]: https://docs.github.com/en/pages/getting-started-with-github-pages/configuring-a-publishing-source-for-your-github-pages-site#publishing-with-a-custom-github-actions-workflow
[latest-tag]: https://github.com/smlee/dev/tags
